...
@Component({
  selector: 'app-youth-programs',
  templateUrl: './youth-programs.component.html',
  styleUrls: ['./youth-programs.component.css']
})

export class YouthProgramsComponent {
  /** Based on the screen size, switch from standard to one column per row */
  cards = [];
  cardsForHandset = [
    {
      "title": "San Francisco islamic Center",
